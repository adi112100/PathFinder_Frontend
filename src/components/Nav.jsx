            ...
            <nav className="navbar navbar-expand-lg navbar-dark bg-dark fixed">
                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                    <ul className="navbar-nav">
                        ...
                        <li><h5 className="navbar-brand" style={{ marginLeft: '20px' }}>Choose Algorithm</h5></li>
                        <li>
                            
                            <select class="custom-select mr-sm-2" id="selectalgo" onChange={()=>{setAlgorithms(document.getElementById('selectalgo').value)}}>
